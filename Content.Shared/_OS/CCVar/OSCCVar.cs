...
namespace Content.Shared.OS.CCVar;

[CVarDefs]
public sealed partial class OSCCVars
{
    /// <summary>
    /// Basic CCVars
    /// </summary>
    public static readonly CVarDef<string> LobbyChangelogsList =
        CVarDef.Create("lobby_changelog.list", "ChangelogOS.yml,Changelog.yml", CVar.SERVER | CVar.REPLICATED);

    public static readonly CVarDef<string> ServerName =
        CVarDef.Create("lobby.server_name", "🛰 Open Space 🪐", CVar.SERVER | CVar.REPLICATED);
